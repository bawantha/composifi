    ...
    Dialog(onDismissRequest = onDismissRequest) {
        Surface(
            ...
            Column(
                ...
                CoolAnimationEffects(modifier = Modifier.size(100.dp))
                ...
                RetroSynthwaveGridAnimation(modifier = Modifier.fillMaxWidth().height(100.dp))
                ...
                DrawWormAnimation(modifier = Modifier.size(100.dp))

                Spacer(modifier = Modifier.height(16.dp))

                FibonacciSpiralAnimation(modifier = Modifier.size(100.dp))

                Spacer(modifier = Modifier.height(16.dp))

                InfinityLoopAnimation(modifier = Modifier.size(100.dp))
